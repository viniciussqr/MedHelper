...
document.getElementById("btnAvançar2").addEventListener("click", function () {
  window.location.href = "Cadastro_Servidor3.html";
});

document.getElementById("btnVoltar2").addEventListener("click", function () {
  window.location.href = "Cadastro_Servidor.html";
});
