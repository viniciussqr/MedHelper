...
document.getElementById("btnAvançar_").addEventListener("click", function () {
  window.location.href = "Cadastro_Médico2.html";
});


document.getElementById("btnVoltar_").addEventListener("click", function () {
